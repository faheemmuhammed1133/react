    ...
    return (
      <>
        ...
        <div className={styles.card_container}>
         ...
         <Link to="/" className={"fa-solid fa-arrow-left "+styles.backBtn}> go back</Link>
                <div>
                    <form onSubmit={handleSubmit}>
                        <input type="text" placeholder='Enter city' className={styles.inp} onChange={handleInputChange} required></input>
                ...
                <img src={icon} alt="Weather icon" className={styles.image} />
                <div>
